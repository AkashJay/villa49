...
<html>
<head>
<title>Contact | Villa 49 HotelBeds</title>
					...
					<div class="container-fluid">
						...
						<div class="navbar-header">
						  ...
						  <div class="navbar-brand logo">
							<h1><a href="index.html"><span>Vill49  </span> HotelBeds</a></h1>
							</div>
						</div>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						   <ul class="nav navbar-nav">
							...
							<li><a data-hover="Rooms" href="room.php">Rooms</a></li>
							 <li class="active"><a data-hover="Contact" href="contact.php">Contact</a></li>
			...
			<div class="contact">
				<div class="container">
					...
					<div class="col-md-4 contact-left">
						<h4>Address</h4>
						<p>Villa49 HotelBeds
							<span>No:49,Amarasena Mawatha Hikkaduwa</span></p>
						<ul>
							<li>Free Phone :+94 777 555 463</li>
							<li>Telephone :+94 777 555 463</li>
							<li>Fax :+94-112-302-871</li>
							<li><a href="mailto:info@example.com">info@villa49hotelbeds.com</a></li>
						</ul>
					</div>
